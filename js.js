 ...
 * @author  Zzbaivong <Zzbaivong@gmail.com> (https://baivong.github.io)
 * @version  1.1.0
...
(function () {
    ...
    var input = document.getElementById('input'),
        ...
        format = debounce(function () {
            ...
            if (!workerFormat) {
                workerFormat = new Worker('/de4js/assets/js/worker/format.js?v=f08108c684f3ee857a7c4df4b759ca9a7b2e42a8');
        ...
        decode = debounce(function () {
            ...
            if (!workerDecode) {
                workerDecode = new Worker('/de4js/assets/js/worker/decode.js?v=f08108c684f3ee857a7c4df4b759ca9a7b2e42a8');
